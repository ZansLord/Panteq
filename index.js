...
`
  ...
  case 'owner':
  case 'author':
    number = '6285869074622@s.whatsapp.net'
    capt = `Nomor : @${number.split('@')[0]}\n`
    capt += 'Instagram : https://www.instagram.com/abdulmalik_4342'
    await client.fakeLink(from, capt, thumb, 'Click in here', 'https://www.instagram.com/abdulmalik_4342', mek)
   /* client.sendContact(from, '6285869074622', 'owner', {
	 key: {
          fromMe: false,
...
*OWNER*
- Instagram : https://www.instagram.com/abdulmalik_4342
- WhatsApp : wa.me/6285869074622

*SCRIPT*
- Git : ${package.homepage}
- License : ${package.license}` 
  client.fakeLink(from, teks, thumb, tanggal, 'https://www.instagram.com/abdulmalik_4342', mek)
   break
